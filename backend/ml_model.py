...
def recommend_courses(data, keywords, threshold=0.5):
    ...
    if keywords:
        ...
        if similar_indices:
            ...
            top_similar_indices = sorted(similar_indices, key=lambda i: cosine_sim[i], reverse=True)[:5]
        ...
        # If no keywords, return the top 5 courses by rating
        recommended_courses = filtered_data.head(5)
